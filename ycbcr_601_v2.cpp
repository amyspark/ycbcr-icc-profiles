...
#if defined BT1886
    cmsMLUsetASCII(description, "en", "US", "ITU-R BT.601-7 + BT.1886 YCbCr ICC V2 profile");
#else
...
#if defined BT1886
    const std::string profileName{"bt601-7_bt1886_ycbcr_v2.icc"};
#else
    const std::string profileName{"bt601-7_ycbcr_v2.icc"};
#endif
